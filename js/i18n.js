...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      mcp_tools_empty_disconnected: 'MCP necesita que ZeroChat se inicie desde zerochat.py para descubrir y activar herramientas del sistema.',
    ...
    en: {
      ...
      mcp_tools_empty_disconnected: 'MCP requires ZeroChat to be started from zerochat.py to discover and enable local system tools.',
