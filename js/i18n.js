...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      btn_rag: 'Conocimiento',
      btn_rag_title: 'Gestionar conocimiento local',
    ...
    en: {
      ...
      btn_rag: 'Knowledge',
      btn_rag_title: 'Manage local knowledge',
