...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      tab_mcp: 'MCP',
      mcp_connection_title: 'Gestor MCP (mcp-proxy)',
      mcp_connection_desc: 'Puente local para conectar ZeroChat con herramientas y servidores del Model Context Protocol (MCP) vía HTTP/SSE.',
      ...
      mcp_setup_modal_title: 'Configuración de MCP (mcp-proxy)',
      mcp_field_host: 'Host del proxy',
      mcp_field_host_placeholder: '127.0.0.1',
      mcp_field_port: 'Puerto (Rango 63xx recomendado)',
      mcp_field_port_placeholder: '6388',
      mcp_instructions_title: 'Instrucciones de Instalación y Arranque',
      mcp_instructions_desc: 'Ejecuta el siguiente comando en tu terminal para instalar/actualizar y arrancar mcp-proxy en un entorno Python privado (~/.zerochat/mcp-env):',
      ...
      mcp_tools_empty_disconnected: 'Conecta con mcp-proxy para descubrir y activar herramientas locales del sistema.',
    ...
    en: {
      ...
      tab_inspector: 'Inspector',
      tab_mcp: 'MCP',
      mcp_connection_title: 'MCP Manager (mcp-proxy)',
      mcp_connection_desc: 'Local bridge to connect ZeroChat with Model Context Protocol (MCP) tools and servers via HTTP/SSE.',
      ...
      mcp_setup_modal_title: 'MCP Configuration (mcp-proxy)',
      mcp_field_host: 'Proxy Host',
      mcp_field_host_placeholder: '127.0.0.1',
      mcp_field_port: 'Port (63xx range recommended)',
      mcp_field_port_placeholder: '6388',
      mcp_instructions_title: 'Installation & Launch Instructions',
      mcp_instructions_desc: 'Run the following command in your terminal to install/update and start mcp-proxy in a private Python environment (~/.zerochat/mcp-env):',
      ...
      mcp_tools_empty_disconnected: 'Connect to mcp-proxy to discover and enable local system tools.',
