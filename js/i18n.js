...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      welcome_help_href: 'help/index.html',
      ...
      btn_install_pwa_title: 'Instalar ZeroChat',
      pwa_install_ios_instructions: 'Para instalar ZeroChat, pulsa Compartir en Safari y elige “Añadir a pantalla de inicio”.',
      btn_rag: 'RAG',
      btn_rag_title: 'Gestionar conocimiento local (RAG)',
      rag_modal_title: 'Conocimiento local',
      rag_modal_title_activate: 'RAG',
      rag_modal_title_manage: 'RAG. Gestionar',
      rag_menu_label: 'RAG',
      rag_help_link_text: '¿Necesitas ayuda con RAG?',
      rag_help_link_label: 'Ver guía completa',
      ...
      rag_no_branches_active: 'No hay ramas. Crea la primera desde RAG en Configuración.',
      rag_status_desc_multi: 'El agente consultará en paralelo las {count} ramas activas en cada búsqueda.',
      rag_mixed_languages_warning: 'Hay ramas documentales activas con idiomas distintos: {languages}. Este aviso no cambia la activación; ten en cuenta el idioma de cada conjunto al formular consultas.',
      ...
      rag_btn_stop_ingestion: 'Detener',
      rag_ingestion_stopping: 'Deteniendo ingesta...',
      rag_ingestion_cancelled: 'Ingesta detenida por el usuario',
      rag_duplicate_title: 'Documento duplicado',
      rag_duplicate_prompt: 'Ya existe un documento con el mismo nombre y ruta en esta rama ("{name}"). ¿Deseas reemplazarlo o ignorarlo?',
      ...
      rag_duplicate_skipped: '{name} omitido (duplicado)',
      rag_duplicate_replaced: '{name} reemplazado con éxito',
      ...
      reasoning_intensity_none: 'Ninguno',
      reasoning_intensity_max: 'Máximo',
      ...
      debug_tab_all: 'Todo',
      debug_tabs_label: 'Filtros de logs',
      ...
      settings_agent: 'Agente',
      settings_model: 'Modelo',
      settings_inspector: 'Inspector',
      settings_mcp: 'MCP',
      settings_permissions: 'Permisos',
      settings_encryption_password: 'Contraseña de cifrado',
      settings_encryption_default: 'Usar clave predeterminada',
      settings_encryption: 'Cifrado',
      sidebar_encryption_title: 'Opciones de cifrado',
      encryption_back: 'Volver',
      encryption_new_password: 'Nueva contraseña',
      encryption_default: 'Usar predeterminada',
      crypto_password_title: 'Protección de API keys',
      crypto_new_password_prompt: 'Introduce la nueva contraseña de cifrado:',
      crypto_confirm_password_prompt: 'Confirma la nueva contraseña de cifrado:',
      crypto_current_password_prompt: 'Introduce la contraseña de cifrado actual:',
      crypto_password_empty: 'La contraseña de cifrado no puede estar vacía.',
      crypto_password_mismatch: 'Las contraseñas no coinciden.',
      crypto_password_saved: 'Las API keys se han recifrado y la contraseña queda desbloqueada temporalmente.',
      crypto_default_confirm: 'Se recifrarán todas las API keys con la clave predeterminada de ZeroChat. Se solicitará la clave actual si fuera necesaria. ¿Continuar?',
      crypto_default_saved: 'Las API keys usan ahora la clave predeterminada de ZeroChat.',
      crypto_default_no_api_keys: 'No hay API keys guardadas; no se ha modificado nada.',
      crypto_password_error: 'No se pudo actualizar la protección de las API keys: {err}',
      mcp_connection_title: 'Servidor Local',
      ...
      mcp_bootstrap_desc: 'Instala ZeroChat desde PyPI y ejecútalo en un terminal. La aplicación se conectará automáticamente cuando el servidor esté disponible.',
      mcp_bootstrap_direct: 'Alternativa sin instalación: descarga zerochat.py y ejecútalo con Python.',
      mcp_reconnect_after_restart: 'Si el servidor se ha reiniciado, recarga esta página (F5) para volver a conectar.',
      mcp_bootstrap_help: 'Abrir ayuda de MCP',
      ...
      mcp_tools_empty_disconnected: 'MCP necesita que ZeroChat se ejecute localmente para descubrir y activar herramientas del sistema.',
      mcp_tools_empty_connected: 'El servidor local está conectado pero no expone ninguna herramienta.',
      browser_action_requirements_notice: 'La automatización del navegador necesita Node.js, Playwright y Chromium. Instálalos siguiendo la guía: Ayuda → Automatización del navegador.',
      mcp_servers_section_title: 'Servidores MCP Disponibles',
      mcp_servers_section_desc: 'Servicios MCP externos configurados en el servidor local listos para arrancar de forma individual.',
      mcp_servers_empty: 'No hay servidores MCP externos disponibles en el servidor local.',
      ...
      mcp_security_policy_allow_all_hint: 'Ejecuta inmediatamente las herramientas MCP no sujetas a reglas de directorio.',
      ...
      mcp_directory_rules_title: 'Directorios permitidos',
      mcp_directory_rules_hint: 'Una regla por línea: R: para leer, W: para modificar y RW: para ambas operaciones. Usa * para un segmento y ** para subdirectorios.',
      mcp_directory_rules_invalid: 'Regla de directorio inválida.',
      ...
      tool_auth_allow_path_btn: 'Permitir {access} en esta carpeta',
      tool_auth_allow_path_title: 'Añadir una regla de directorio para esta carpeta',
      ...
      field_language_short: 'Idioma',
      field_theme_short: 'Tema',
      field_profile: 'Perfil de Conexión / Servidor',
      sidebar_settings_title: 'Configuración',
      sidebar_help: 'Ayuda',
      sidebar_help_href: 'help/index.html',
      ...
      btn_export_profiles: 'Exportar',
      btn_export_profiles_title: 'Exportar todos los perfiles a un archivo cifrado',
      profiles_backup_title: 'Copia y restauración de perfiles',
      profiles_backup_description: 'Estas acciones afectan a todos los perfiles editables, no solo al perfil seleccionado.',
      confirm_import_profiles: 'Se cargarán {count} perfiles y se sustituirán los que tengan el mismo identificador. ¿Deseas continuar?',
      msg_profiles_exported: 'Copia cifrada de perfiles creada.',
      msg_profiles_exported_html: 'Perfiles exportados. Abre el archivo HTML descargado para importarlos automáticamente.',
      msg_profiles_imported: 'Perfiles cargados: {added} nuevos y {replaced} actualizados.',
      msg_profiles_auto_imported: 'Importación completada: {added} nuevo(s), {replaced} actualizado(s).',
      err_profiles_backup: 'No se pudo procesar la copia de perfiles: {err}',
      err_no_profiles_to_export: 'No hay perfiles para exportar (excepto el perfil Espejo).',
      err_auto_import_failed: 'Error al importar perfiles automáticamente: {err}',
      confirm_auto_import_profiles: '¿Importar {count} perfil(es) de conexión desde el archivo externo?',
      ...
      profile_save_pending: 'Hay cambios pendientes. Guarda el perfil para conservarlos.',
      ...
      confirm_settings_unsaved_changes: 'Hay cambios sin guardar en la configuración. ¿Deseas descartarlos y cerrar?',
      confirm_rag_branch_unsaved_changes: 'Hay cambios sin guardar en la rama. ¿Deseas descartarlos y cerrar?',
      ...
      btn_edit_profile_title: 'Editar este perfil',
      btn_inspect_profile_title: 'Inspeccionar este perfil',
      btn_delete_profile_item_title: 'Eliminar este perfil',
      btn_close_profiles_menu: 'Cerrar selector',
      field_api_type: 'Tipo de Interfaz / Protocolo',
      profile_api_key_lock: 'Bloquear cambios',
      profile_api_key_locked: 'Cambios bloqueados',
      ...
      field_api_key_required_hint: 'Obligatoria para este proveedor.',
      field_api_key_free_help: 'Cómo obtener una API key gratuita',
      ...
      sidebar_chat_options_title: 'Más opciones de conversación',
    ...
    en: {
      ...
      welcome_help_href: 'help/en/index.html',
      ...
      mirror_response_about: '## ZeroChat, your way\n\nZeroChat brings conversations, tools, and local knowledge together in a flexible interface. Connect it to local models or remote providers with independent connection profiles. To explore all capabilities and setup guides, check out the [general help and documentation](help/en/index.html).',
      ...
      btn_install_pwa_title: 'Install ZeroChat',
      pwa_install_ios_instructions: 'To install ZeroChat, tap Share in Safari and choose “Add to Home Screen”.',
      btn_rag: 'RAG',
      btn_rag_title: 'Manage local knowledge (RAG)',
      rag_modal_title: 'Local knowledge',
      rag_modal_title_activate: 'RAG',
      rag_modal_title_manage: 'RAG. Manage',
      rag_menu_label: 'RAG',
      rag_help_link_text: 'Need help with RAG?',
      rag_help_link_label: 'View complete guide',
      ...
      rag_no_branches_active: 'No branches available. Create the first one from RAG in Settings.',
      rag_status_desc_multi: 'The agent will query the {count} active branches in parallel for each search.',
      rag_mixed_languages_warning: 'Active documentary branches use different languages: {languages}. This notice does not change activation; consider each collection language when formulating queries.',
      ...
      rag_btn_stop_ingestion: 'Stop',
      rag_ingestion_stopping: 'Stopping ingestion...',
      rag_ingestion_cancelled: 'Ingestion stopped by user',
      rag_duplicate_title: 'Duplicate document',
      rag_duplicate_prompt: 'A document with the same name and path already exists in this branch ("{name}"). Do you want to replace it or ignore it?',
      rag_btn_replace: 'Replace',
      rag_btn_ignore: 'Ignore',
      rag_duplicate_apply_all: 'Apply to all remaining duplicates in this load',
      rag_duplicate_skipped: '{name} skipped (duplicate)',
      rag_duplicate_replaced: '{name} replaced successfully',
      ...
      reasoning_intensity_none: 'None',
      reasoning_intensity_max: 'Maximum',
      ...
      settings_encryption_password: 'Encryption password',
      settings_encryption_default: 'Use default key',
      settings_encryption: 'Encryption',
      sidebar_encryption_title: 'Encryption options',
      encryption_back: 'Back',
      encryption_new_password: 'New password',
      encryption_default: 'Use default',
      crypto_password_title: 'API key protection',
      crypto_new_password_prompt: 'Enter the new encryption password:',
      crypto_confirm_password_prompt: 'Confirm the new encryption password:',
      crypto_current_password_prompt: 'Enter the current encryption password:',
      crypto_password_empty: 'The encryption password cannot be empty.',
      crypto_password_mismatch: 'The passwords do not match.',
      crypto_password_saved: 'API keys were re-encrypted and the password is temporarily unlocked.',
      crypto_default_confirm: 'All API keys will be re-encrypted with ZeroChat’s default key. The current key will be requested if needed. Continue?',
      crypto_default_saved: 'API keys now use ZeroChat’s default key.',
      crypto_default_no_api_keys: 'There are no saved API keys, so nothing was changed.',
      crypto_password_error: 'Could not update API key protection: {err}',
      mcp_connection_title: 'Local Server',
      ...
      mcp_bootstrap_desc: 'Install ZeroChat from PyPI and run it in a terminal. The application will connect automatically when the server is available.',
      mcp_bootstrap_direct: 'Alternative without installation: download zerochat.py and run it with Python.',
      mcp_reconnect_after_restart: 'If the server was restarted, reload this page (F5) to connect again.',
      mcp_bootstrap_help: 'Open MCP help',
      ...
      mcp_tools_empty_disconnected: 'MCP requires ZeroChat to run locally to discover and enable local system tools.',
      mcp_tools_empty_connected: 'The local server is connected but does not expose any tools.',
      browser_action_requirements_notice: 'Browser automation needs Node.js, Playwright, and Chromium. Install them using the guide: Help → Browser automation.',
      mcp_servers_section_title: 'Available MCP Servers',
      mcp_servers_section_desc: 'External MCP services configured on the local server ready to start individually.',
      mcp_servers_empty: 'No external MCP servers available on the local server.',
      ...
      mcp_security_policy_allow_all_hint: 'Immediately executes MCP tools that are not subject to directory rules.',
      ...
      mcp_directory_rules_title: 'Allowed directories',
      mcp_directory_rules_hint: 'One rule per line: R: to read, W: to modify, and RW: for both. Use * for one segment and ** for subdirectories.',
      mcp_directory_rules_invalid: 'Invalid directory rule.',
      tool_auth_allow_cmd_btn: 'Always allow "{cmd}"',
      tool_auth_allow_cmd_title: 'Permanently allow only commands starting with "{cmd}"',
      tool_auth_allow_path_btn: 'Allow {access} in this folder',
      tool_auth_allow_path_title: 'Add a directory rule for this folder',
      ...
      field_language_short: 'Language',
      field_theme_short: 'Theme',
      field_profile: 'Connection Profile / Server',
      sidebar_settings_title: 'Settings',
      sidebar_help: 'Help',
      sidebar_help_href: 'help/en/index.html',
      ...
      btn_export_profiles: 'Export',
      btn_export_profiles_title: 'Export all profiles to an encrypted file',
      profiles_backup_title: 'Profile backup and restore',
      profiles_backup_description: 'These actions affect all editable profiles, not only the selected profile.',
      confirm_import_profiles: '{count} profiles will be loaded, replacing those with the same identifier. Do you want to continue?',
      msg_profiles_exported: 'Encrypted profile backup created.',
      msg_profiles_exported_html: 'Profiles exported. Open the downloaded HTML file to import them automatically.',
      msg_profiles_imported: 'Profiles loaded: {added} new and {replaced} updated.',
      msg_profiles_auto_imported: 'Import completed: {added} new, {replaced} updated.',
      err_profiles_backup: 'Could not process the profile backup: {err}',
      err_no_profiles_to_export: 'No profiles to export (except Mirror profile).',
      err_auto_import_failed: 'Failed to auto-import profiles: {err}',
      confirm_auto_import_profiles: 'Import {count} connection profile(s) from external file?',
      ...
      profile_save_changes_required: 'Make a profile change to enable saving.',
      profile_save_pending: 'There are pending changes. Save the profile to keep them.',
      ...
      confirm_settings_unsaved_changes: 'There are unsaved configuration changes. Do you want to discard them and close?',
      confirm_rag_branch_unsaved_changes: 'There are unsaved branch changes. Do you want to discard them and close?',
      ...
      btn_edit_profile_title: 'Edit this profile',
      btn_inspect_profile_title: 'Inspect this profile',
      btn_delete_profile_item_title: 'Delete this profile',
      btn_close_profiles_menu: 'Close selector',
      field_api_type: 'Interface Type / Protocol',
      profile_api_key_lock: 'Lock changes',
      profile_api_key_locked: 'Changes locked',
      ...
      field_api_key_required_hint: 'Required for this provider.',
      field_api_key_free_help: 'How to get a free API key',
      ...
      sidebar_chat_options_title: 'More conversation options',
