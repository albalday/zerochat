...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      reasoning_checkpoint_agent_desc: 'Consolida hallazgos y poda memoria en modelos abiertos o RAG',
      reasoning_checkpoint_agent_tooltip: 'Activar o desactivar herramienta agent_checkpoint',
      agent_checkpoint_title: 'Punto de Control y Compactación de Memoria',
      agent_checkpoint_desc: 'Permite al modelo consolidar hallazgos, solicitar asistencia y podar memoria pesada de herramientas para razonar sin pérdida de foco.',
      ...
      tool_agent_checkpoint_compacted: 'Memoria previa compactada',
...
find ~/storage/downloads -name zerochat_mcp.py -print`,
    ...
    en: {
      ...
      rag_active_tip_desc: 'RAG effectiveness relies heavily on the <strong>intelligence, multimodal vision</strong> (to interpret tables, charts, and images), and <strong>agentic reasoning capability</strong> of the selected model: it is essential for formulating precise queries, inspecting adjacent chunks, and evaluating evidence accurately. If using smaller models or models with limited agentic capabilities, enable the <strong>Agent Checkpoint (agent_checkpoint)</strong> from the Reasoning menu to consolidate findings and prevent context saturation.',
      ...
      rag_help_checkpoint_desc: 'Compact models or models with a small context window can easily get saturated when accumulating multiple document chunks. Enable the <strong>Agent Checkpoint (agent_checkpoint)</strong> from the Reasoning menu: it lets the model consolidate intermediate findings, flush working memory, and continue investigating without losing coherence. Especially recommended for models with fewer than 14B parameters or context windows below 32k tokens.',
      ...
      reasoning_checkpoint_agent_desc: 'Consolidates findings and compacts memory in open models or RAG',
      reasoning_checkpoint_agent_tooltip: 'Enable or disable agent_checkpoint tool',
      agent_checkpoint_title: 'Agent Checkpoint & Memory Compaction',
      agent_checkpoint_desc: 'Allows the model to consolidate findings, request guidance, and prune heavy tool outputs to maintain reasoning focus.',
      ...
      tool_agent_checkpoint_compacted: 'Previous memory compacted',
