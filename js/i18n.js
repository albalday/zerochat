...
(function (root, factory) {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      mirror_response_about: '## ZeroChat, a tu manera\n\nZeroChat reúne conversaciones, herramientas y conocimiento local en una interfaz flexible. Puedes conectarlo a modelos locales o proveedores remotos mediante perfiles de conexión independientes. Para conocer todas sus posibilidades y guías de configuración, consulta la [ayuda y documentación general](http://albalday.github.io/zerochat/help/index.html).',
      ...
      tool_loading_js: 'Ejecutando código JavaScript...',
      ...
      tool_search_sources_label: 'Fuentes y resultados encontrados:',
      ...
      tool_rag_image_title: 'Imagen RAG',
...
find ~/storage/downloads -name zerochat_mcp.py -print`,
      ...
      mcp_no_tools: 'Sin herramientas registradas',
      mcp_tools_section_title: 'Herramientas Disponibles del Sistema',
      mcp_tools_count: '{count} detectadas',
      mcp_tools_empty_disconnected: 'Inicia el servidor Python local para descubrir y activar herramientas del sistema.',
      mcp_tools_empty_connected: 'El servidor local está conectado pero no expone ninguna herramienta.',
      mcp_tool_badge: 'MCP',
      ...
      confirm_profile_query_not_saved: 'La consulta se ha completado, pero el perfil no se ha guardado. ¿Deseas descartar los cambios y cerrar?',
      confirm_profile_unsaved_changes: 'Hay cambios sin guardar en el perfil. ¿Deseas descartarlos y cerrar?',
      ...
      webllm_help_link: 'Guía de configuración WebLLM',
      webllm_query_optional: 'Modelo descargado listo. La consulta al servidor es opcional.',
      ...
      btn_webllm_params_title: 'Parámetros avanzados de rendimiento WebLLM',
      webllm_params_title: 'Parámetros de ejecución WebGPU',
      webllm_opt_default: 'Por defecto del modelo',
      field_webllm_context_window: 'Ventana de contexto (context_window_size)',
      field_webllm_prefill_chunk: 'Bloque de prefill (prefill_chunk_size)',
      ...
      agent_js_title: 'Ejecución de JavaScript (Cálculos locales)',
      agent_js_desc: 'Permite al modelo ejecutar JavaScript en un worker local para facilitar cálculos, procesamiento de datos y algoritmos bajo la supervisión y conocimiento de un usuario técnico.',
      ...
      confirm_clear_all_data: '¿Borrar todos los datos de este origen: configuración, chats, adjuntos, RAG, modelos descargados, cookies, IndexedDB, cachés y archivos locales del navegador? También afecta a otras aplicaciones que compartan este origen. Cierra las otras pestañas de ZeroChat antes de continuar.\n\nNo se puede deshacer. La aplicación se recargará. HTTP y file:// tienen almacenamientos separados.',
      clear_all_data_failed: 'No se pudo completar el borrado. Cierra las otras pestañas y detén las operaciones activas antes de reintentar. Puedes eliminar los datos del sitio desde los ajustes del navegador.',
      clear_all_data_failed_detail: 'No se pudo completar el borrado. Detalle: {detail}',
      btn_cancel: 'Cancelar',
      ...
      err_server_connect_title: 'Error al conectar con el servidor:',
      ...
      err_file_too_large: 'El archivo "{name}" supera el tamaño máximo permitido ({max}).',

      // Markdown & JavaScript
      md_thought_title: 'Proceso de razonamiento',
      md_thought_reasoning: 'Razonando...',
      md_run_js_title: 'Ejecutar JavaScript (en worker local)',
    ...
    en: {
      ...
      mirror_response_about: '## ZeroChat, your way\n\nZeroChat brings conversations, tools, and local knowledge together in a flexible interface. Connect it to local models or remote providers with independent connection profiles. To explore all capabilities and setup guides, check out the [general help and documentation](http://albalday.github.io/zerochat/help/en/index.html).',
      ...
      tool_loading_js: 'Executing JavaScript code...',
      ...
      tool_search_sources_label: 'Sources and results found:',
      ...
      tool_rag_image_title: 'RAG Image',
...
find ~/storage/downloads -name zerochat_mcp.py -print`,
      ...
      mcp_no_tools: 'No tools registered',
      mcp_tools_section_title: 'Available System Tools',
      mcp_tools_count: '{count} detected',
      mcp_tools_empty_disconnected: 'Start the local Python server to discover and enable local system tools.',
      mcp_tools_empty_connected: 'The local server is connected but does not expose any tools.',
      mcp_tool_badge: 'MCP',
      ...
      confirm_profile_query_not_saved: 'The query completed, but the profile has not been saved. Do you want to discard changes and close?',
      confirm_profile_unsaved_changes: 'There are unsaved changes in the profile. Do you want to discard them and close?',
      ...
      webllm_help_link: 'WebLLM Setup Guide',
      webllm_query_optional: 'Downloaded model ready. Querying the server is optional.',
      ...
      btn_webllm_params_title: 'Advanced WebLLM performance parameters',
      webllm_params_title: 'WebGPU execution parameters',
      webllm_opt_default: 'Model default',
      field_webllm_context_window: 'Context window (context_window_size)',
      field_webllm_prefill_chunk: 'Prefill chunk size (prefill_chunk_size)',
      ...
      agent_js_title: 'JavaScript Execution (Local calculations)',
      agent_js_desc: 'Allows the model to execute JavaScript in a local worker to facilitate calculations, data processing, and algorithms under the supervision and awareness of a technical user.',
      ...
      confirm_clear_all_data: 'Delete all data for this origin: settings, chats, attachments, RAG, downloaded models, cookies, IndexedDB, caches and browser-local files? This also affects other applications sharing this origin. Close other ZeroChat tabs before continuing.\n\nThis cannot be undone. The application will reload. HTTP and file:// have separate storage.',
      clear_all_data_failed: 'Deletion could not be completed. Close other tabs and stop active operations before retrying. You can remove site data from your browser settings.',
      clear_all_data_failed_detail: 'Deletion could not be completed. Detail: {detail}',
      btn_cancel: 'Cancel',
      ...
      err_server_connect_title: 'Error connecting to server:',
      ...
      err_file_too_large: 'File "{name}" exceeds the maximum allowed size ({max}).',

      // Markdown & JavaScript
      md_thought_title: 'Reasoning process',
      md_thought_reasoning: 'Reasoning...',
      md_run_js_title: 'Run JavaScript (in local worker)',
